...
def run(protocol: protocol_api.ProtocolContext):
    ...
    # ### Prompt user to place plate on mag block - this is line 1 of the protocol on opentrons app
    ...
    mbw_remaining, mbw_wells = bead_wash(
                                         ...
                                         mag_plate,
                                         cols,
                                         #pipette_right.blow_out(waste['A1']),
                                         # super arguments - looks like droplets here after dispensing into waste. Maybe add: "pipette_right.blow_out()" and to those below
                                         waste['A1'],
                                         tiprack_wash,
    ...
    for col in cols:
        ...
        #pipette_right.air_gap(10)#to eliminate dripping after dispensing into magplate
